...
({
    ...
    handleFilterChange: function(component, event, helper) {
		...
		console.log("after initCallsRunning");
        helper.getRecordByValue(component, event, helper);
        console.log("after getRecordByValue");
        helper.getRecentRecords(component, event, helper);
		console.log("after getRecentRecords");
        if(component.find('lookupInput') == true) {
            component.find('lookupInput').getElement().value = '';
             console.log("after lookupInput");
             helper.getRecordsBySearchTerm(component, event, helper);
            console.log("after getRecordsBySearchTerm");
        }
