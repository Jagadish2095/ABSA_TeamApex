({
	initComp : function(component, event, helper) {
		helper.SecurityCessionOfShortTermInsuranceHelper(component, event, helper);
	},
    viewAllCessionofSchemes : function(component, event, helper) {
    ...
    selectedItem : function(component,event,helper){
        ...
        for(var i = 0;i < minimumList.length;i++){
            if(minimumList[i].polnoOut == id_str){
