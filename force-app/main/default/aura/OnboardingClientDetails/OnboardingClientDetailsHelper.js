({
    ...
    CreateBusinessAccount : function(component, event, helper){
        ...
        var placeOfResidence = component.get('v.placeOfResidence');
        ...
        action.setParams({
            ...
            "processType" : processTypeValue,// PJAIN: 20200331
            "processName" : processName,// W-010629-added by Manish so that value can be passed form continue onboarding
        ...
        action.setCallback(this, function(response) {
            ...
            if (state == "SUCCESS") {
                ...
                if(relatedP != null) {
                    relatedP.getOnboardingAccountId(component.get('v.accRecordId'),component.get('v.processType'));
                ...
                if(uboStructure != null) {
                    uboStructure.getOnboardingUBOAccountId(component.get('v.accRecordId'),component.get('v.processType'));
    ...
    showValidations : function(component) {  
        ...
        var clientTypeVal = component.get('v.accountRecord.Client_Type__c');
        
        //TdB - Onboard New to Bank vs Lite Onboarding validation on Big Form
        if(processType != 'Lite Onboarding' && clientTypeVal != 'Joint & Several' && processType != 'Surety Onboarding') {
    ...
    createProspectBasedOnPopup: function(component) {
        ...
        action.setParams({
            ...
            "agreedPolicy" :component.get("v.isAgreedPrivacypolicy"), //consent for spm
        ...
        action.setCallback(this, function(response) {
            if (response.getState() == "SUCCESS") {
               ...
               var relatedubo = component.find('uboListViewCmp');
                if(relatedubo != null) {
                    relatedubo.getOnboardingUBOAccountId(component.get('v.accRecordId'),component.get('v.processType'));
 ...
 // Added by Masechaba Maseli to update CIF   
