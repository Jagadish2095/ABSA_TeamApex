({
    sendAvafPaidUpHelper: function (component, event, helper) {
        let button = event.getSource();
        button.set("v.disabled", true);
        component.set("v.isShowSpinner", true);
        var action = component.get("c.sendPaidUpLetter");
        action.setParams({
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set("v.errorMessage", "Error in sendAvafPaidUpHelper method. Error message: " + JSON.stringify(errors));
            } else {
                component.set("v.errorMessage", "Unknown error in sendAvafPaidUpHelper method. State: " + state);
            }
