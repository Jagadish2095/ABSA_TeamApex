({
	initComp : function(component, event, helper) {
		helper.SecurityCessionOfSchemesHelper(component, event, helper);
	},
    viewAllLetterOfUnderstanding : function(component, event, helper) {
    ...
    selectedItem : function(component,event,helper){
        ...
        for(var i = 0;i < minimumList.length;i++){
            if(minimumList[i].refAcc == id_str){
