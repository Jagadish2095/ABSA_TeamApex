      ...
      /*  var laonPurposes = [
       ...
       /* var agreementCategory = [
        ...
        var caseId = component.get("v.recordId");
            ...
            console.log('qqqq'+component.get("v.recordId"));
        action.setParams({
            "caseId": caseId 
        }); 
        ...
        action.setCallback(this, function (response) {
           ...
           // console.log('response.getReturnValue()---'+JSON.stringify(response.getReturnValue()));
            ...
            if(resp.mandateNumber!=null || resp.mandateNumber!=''){
            console.log('mandateNumber--'+resp.mandateNumber);
            component.set("v.mandateNumber",resp.mandateNumber);
            } 
