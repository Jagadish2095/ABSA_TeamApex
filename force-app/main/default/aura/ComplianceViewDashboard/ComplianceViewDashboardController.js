({
    ...
    doInit: function(component, event, helper) {
       ...
       /* component.set("v.columns", [
        ...
        var code = getParameterByName('0.cName');
        if(code != null){
            component.set('v.jointsParentCode',code.replace(" ", "+"));
            //alert(component.get('v.jointsParentCode'))
        }
    },
...
//To display Attest Client button in the bottom right of the dashboard
    initiateRefresh : function(component, event, helper) { 
        ...
        if (accRec.Client_Type__c == 'Individual' || accRec.Client_Type__c =='Individual - Minor' || accRec.Client_Type__c == 'Non - Resident Entity' || accRec.Client_Type__c == 'Private Individual' || accRec.Client_Type__c == 'Staff' || accRec.Client_Type__c == 'Staff Joint and Several'){
            component.set("v.isAttestation",true);}
        else{
