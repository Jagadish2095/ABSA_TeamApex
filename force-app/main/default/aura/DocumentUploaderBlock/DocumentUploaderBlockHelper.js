({
   ...
   **/
    uploadInChunk: function(component, file, fileContents, startPosition, endPosition, attachId, isDone, event ) {
        ...
        component.set('v.base64Data',getchunk);
        action.setParams({
    ...
    download: function (component, event, docName) {
        
        component.set('v.showSpinner', true);
        var existDocId=component.get('v.existDocId');
        var action = component.get('c.getDocumentContent');
        console.log('existDocIddwd'+existDocId);
        action.setParams({
            "opportunityId": component.get("v.recordId"),
            "documentId": existDocId,
