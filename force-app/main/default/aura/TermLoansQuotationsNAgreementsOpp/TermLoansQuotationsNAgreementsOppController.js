({
    doInit: function (component, event, helper) {
       ...
       // helper.getCaseRec(component);
		...
		helper.fetchQuoteResponseData(component,helper);  
        helper.fetchQuoteRequestData(component,helper);
    ...
    calculate : function(component, event, helper) {
        ...
        if (allValid) {
            ...
            var CIF = component.get("v.recordId.CIF__c");
            console.log('AccNumber' + AccNumber);
            console.log('appProduct' + JSON.stringify(component.get("v.appProduct")));
