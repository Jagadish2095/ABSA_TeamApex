({
	SecurityCessionDebtorsHelper : function(component, event, helper) {
     var pageSize = component.get("v.pageSize");
     component.set('v.isHide', true);
     var action = component.get("c.getCessionofDebtors");
     ...
     console.log("Account " + accountId);
        ...
        action.setCallback(this, function(response) {
            ...
            console.log("Get Seccion Debtors Response **********************************************************" + response);
