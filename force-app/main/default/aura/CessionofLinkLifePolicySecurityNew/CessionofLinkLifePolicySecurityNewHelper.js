({
	SecurityLinkedLifeHelper : function(component, event, helper) {
     var pageSize = component.get("v.pageSize");
    
     var action = component.get("c.getCessionofLinkLifePolicy");
     ...
     console.log("Account " + accountId);
        ...
        action.setCallback(this, function(response) {
            ...
            console.log("getCession life policy Response **********************************************************" + response);
