({
	SecurityHoldsHelper : function(component, event, helper) {
     var pageSize = component.get("v.pageSize");
     component.set('v.isHide', true);
     var action = component.get("c.getAsvSecurityAndHolds");
     ...
     console.log("Account " + accountId);
        ...
        action.setCallback(this, function(response) {
            ...
            console.log("Get Security Holds **********************************************************" + response);
            if (state === "SUCCESS" && response != null) {
                ...
                if(storeResponse != null){
                    console.log("sObject ****** " + storeResponse);
               		component.set("v.oSecurityHolds", storeResponse);
                    /*
