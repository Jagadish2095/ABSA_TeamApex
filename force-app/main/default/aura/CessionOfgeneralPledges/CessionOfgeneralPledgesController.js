({
	initComp : function(component, event, helper) {
		helper.SecurityCessionOfGeneralPledgesHelper(component, event, helper);
	},
    viewAllCessionofDebtors : function(component, event, helper) {
    ...
    selectedItem : function(component,event,helper){
        ...
        for(var i = 0;i < minimumList.length;i++){
            if(minimumList[i].asspldOut == id_str){
