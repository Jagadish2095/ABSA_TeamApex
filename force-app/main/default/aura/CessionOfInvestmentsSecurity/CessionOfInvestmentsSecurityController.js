({
	initComp : function(component, event, helper) {
		helper.SecurityCessionOfInvestmentHelper(component, event, helper);
	},
    viewAllCessionofInternalInvestment : function(component, event, helper) {
    ...
    selectedItem : function(component,event,helper){
        ...
        for(var i = 0;i < minimumList.length;i++){
            if(minimumList[i].ainvnoOut == id_str){
