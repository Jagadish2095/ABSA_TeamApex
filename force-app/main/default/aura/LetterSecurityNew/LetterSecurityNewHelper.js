({
	SecurityCessionOfSchemesHelper : function(component, event, helper) {
     ...
     var action = component.get("c.getAsvLettersV1");
     var accountId = component.get("v.recordId");
        let oppId = component.get("v.OppId");
     console.log("Account1234 " + accountId);
             action.setParams({
            'accountId': accountId,
             'OppId': oppId
          });
                ...
                if(storeResponse != null){
                	...
                	if (storeResponse.length > 0) {
                		...
                		for(var key = 0 ; key < 2 && key< storeResponse.length ; key++){ 
					   		...
					   		console.log('Bond list Muvhuso ' + JSON.stringify(storeResponse[key]));  
                       		count++;
                     	}
                        
                		console.log('Bond listLetter ' + JSON.stringify(bondsList));
