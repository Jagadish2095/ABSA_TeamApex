({
	getRelatedPartyData: function (component, event, helper) {
		return new Promise(function (resolve, reject) {
			console.log("getRelatedPartyData helper: " + component.get("v.accountRecId"));
			...
			action.setCallback(this, function (response) {
				...
				if (state == "SUCCESS") {
					...
					console.log("@@@ related party init");
	...
	getRelatedpartiesCount: function (component) {
		...
		action.setCallback(this, function (response) {
			...
			console.log("getRelatedpartyCount resp: " + JSON.stringify(resp));
