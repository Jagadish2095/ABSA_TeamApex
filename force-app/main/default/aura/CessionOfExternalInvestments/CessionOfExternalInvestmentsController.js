({
	initComp : function(component, event, helper) {
		helper.SecurityCessionOfExternalInvestmentHelper(component, event, helper);
	},
    viewAllCessionOfExternalInvestments : function(component, event, helper) {
    ...
    selectedItem : function(component,event,helper){
        ...
        for(var i = 0;i < minimumList.length;i++){
            if(minimumList[i].invaccnoOut == id_str){
