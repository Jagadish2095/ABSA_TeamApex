({
	init : function(component){
       ...
       // alert('customerCode Flow:'+ customerCode);
        var inputVariables = [{name : 'recordId', type : 'String', value : flowNameRecordId},
                             {name : 'customerCode', type : 'String', value : customerCode}];
        //var inputCodeVariables = [{name : 'customerCode', type : 'String', value : customerCode}];
